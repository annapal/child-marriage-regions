...
clean_IRQ_MICS6 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Iraq MICS6 Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Iraq MICS6 Datasets/hh.sav")
  bh <- read_sav("data/mics/raw_data/Iraq MICS6 Datasets/bh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/IRQ_MICS6_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/IRQ_MICS6_hh_dict.xlsx")
  write_xlsx(bh.dict, "data/mics/data_dictionaries/IRQ_MICS6_bh_dict.xlsx")
