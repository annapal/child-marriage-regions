...
clean_TJK_MICS3 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Tajikistan MICS 2005 SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Tajikistan MICS 2005 SPSS Datasets/hh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/TJK_MICS3_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/TJK_MICS3_hh_dict.xlsx")
