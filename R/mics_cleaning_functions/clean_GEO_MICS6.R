...
clean_GEO_MICS6 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Georgia MICS6 SPSS Datasets/Georgia MICS6 SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Georgia MICS6 SPSS Datasets/Georgia MICS6 SPSS Datasets/hh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/GEO_MICS6_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/GEO_MICS6_hh_dict.xlsx")
