...
clean_WSM_MICS6 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/MICS6 Samoa Datasets/MICS6 Samoa SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/MICS6 Samoa Datasets/MICS6 Samoa SPSS Datasets/hh.sav")
  bh <- read_sav("data/mics/raw_data/MICS6 Samoa Datasets/MICS6 Samoa SPSS Datasets/bh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/WSM_MICS6_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/WSM_MICS6_hh_dict.xlsx")
  write_xlsx(bh.dict, "data/mics/data_dictionaries/WSM_MICS6_bh_dict.xlsx")
  ...
  data$prev_reg <- ifelse(data$prev_reg=="unable to determine the region", NA, data$prev_reg)
