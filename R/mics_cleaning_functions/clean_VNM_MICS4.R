...
clean_VNM_MICS4 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Vietnam_MICS4_Datasets/Vietnam MICS 2010-2011 SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Vietnam_MICS4_Datasets/Vietnam MICS 2010-2011 SPSS Datasets/hh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/VNM_MICS4_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/VNM_MICS4_hh_dict.xlsx")
  ...
  data$prov <- tolower(as.character(as_factor(mics$HHA)))
  data$dist <- tolower(as.character(as_factor(mics$HHB)))
