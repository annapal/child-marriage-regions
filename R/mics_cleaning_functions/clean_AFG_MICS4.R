...
clean_AFG_MICS4 <- function(survey_var) {
  
  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Afghanistan_MICS4_Datasets/Afghanistan MICS 2010-2011 SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Afghanistan_MICS4_Datasets/Afghanistan MICS 2010-2011 SPSS Datasets/hh.sav")
  
  # Create data dictionaries
  wm.dict <- generate_dictionary(wm)
  hh.dict <- generate_dictionary(hh)
  
  # Write data dictionaries to excel file
  write_xlsx(wm.dict, "data/mics/data_dictionaries/AFG_MICS4_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/AFG_MICS4_hh_dict.xlsx")
