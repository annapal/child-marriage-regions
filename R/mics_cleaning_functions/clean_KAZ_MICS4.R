...
clean_KAZ_MICS4 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Kazakhstan_MICS4_Datasets/Kazakhstan MICS 2010-11 SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Kazakhstan_MICS4_Datasets/Kazakhstan MICS 2010-11 SPSS Datasets/hh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/KAZ_MICS4_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/KAZ_MICS4_hh_dict.xlsx")
  ...
  data$relig <- ifelse(data$relig=="hristian", "christian", data$relig)
