...
clean_PAK_MICS5_Punjab <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Pakistan (Punjab)_MICS5_Datasets/Pakistan (Punjab) MICS 2014 SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Pakistan (Punjab)_MICS5_Datasets/Pakistan (Punjab) MICS 2014 SPSS Datasets/hh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/PAK_MICS5_Punjab_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/PAK_MICS5_Punjab_hh_dict.xlsx")
  ...
  data$survey <- "MICS"
  data$phase <- 5
  data$surveyid <- "PAK_MICS5_Punjab"
