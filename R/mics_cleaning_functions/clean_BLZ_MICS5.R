...
clean_BLZ_MICS5 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Belize_MICS5_Datasets/Belize MICS 2015-16 SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Belize_MICS5_Datasets/Belize MICS 2015-16 SPSS Datasets/hh.sav")
  bh <- read_sav("data/mics/raw_data/Belize_MICS5_Datasets/Belize MICS 2015-16 SPSS Datasets/bh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/BLZ_MICS5_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/BLZ_MICS5_hh_dict.xlsx")
  write_xlsx(bh.dict, "data/mics/data_dictionaries/BLZ_MICS5_bh_dict.xlsx")
  ...
  data$psu <- data$clust
  data$strata <- as.numeric(mics$stratum2)
  summary(data$strata)
  ...
  data$relig <- ifelse(data$relig=="none", "no religion", data$relig)
