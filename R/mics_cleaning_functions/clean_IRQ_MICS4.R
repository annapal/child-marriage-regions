...
clean_IRQ_MICS4 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Iraq_MICS4_Datasets/Iraq MICS 2011 SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Iraq_MICS4_Datasets/Iraq MICS 2011 SPSS Datasets/hh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/IRQ_MICS4_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/IRQ_MICS4_hh_dict.xlsx")
  ...
  data$region <- tolower(as.character(as_factor(mics$HH71)))
  data$prov <- tolower(as.character(as_factor(mics$HH72R)))
  data$dist <- NA
