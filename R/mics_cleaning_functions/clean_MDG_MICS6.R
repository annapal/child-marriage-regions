...
clean_MDG_MICS6 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Madagascar MICS6 datasets/Madagascar MICS6 SPSS datasets/wm.sav")
  bh <- read_sav("data/mics/raw_data/Madagascar MICS6 datasets/Madagascar MICS6 SPSS datasets/bh.sav")
  hh <- read_sav("data/mics/raw_data/Madagascar MICS6 datasets/Madagascar MICS6 SPSS datasets/hh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/MDG_MICS6_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/MDG_MICS6_hh_dict.xlsx")
  write_xlsx(bh.dict, "data/mics/data_dictionaries/MDG_MICS6_bh_dict.xlsx")
  ...
  data$relig <- ifelse(data$relig=="traditionnelle/anemiste", "animist", data$relig)
  ...
  data$relig <- ifelse(data$relig=="protestant (flm/fjkm)", "protestant", data$relig)
  ...
  data$prev_reg <- ifelse(data$prev_reg=="hors de madagascar", "international", data$prev_reg)
