...
clean_PSE_MICS5 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/State of Palestine_MICS5_Datasets/State of Palestine MICS 2014 Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/State of Palestine_MICS5_Datasets/State of Palestine MICS 2014 Datasets/hh.sav")
  bh <- read_sav("data/mics/raw_data/State of Palestine_MICS5_Datasets/State of Palestine MICS 2014 Datasets/bh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/PSE_MICS5_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/PSE_MICS5_hh_dict.xlsx")
  write_xlsx(bh.dict, "data/mics/data_dictionaries/PSE_MICS5_bh_dict.xlsx")
