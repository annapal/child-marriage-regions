...
clean_PAK_MICS5_Gilgit_Baltistan <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Pakistan (Gilgit Baltistan)_MICS5_Datasets/Pakistan (Gilgit Baltistan)_MICS5_Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Pakistan (Gilgit Baltistan)_MICS5_Datasets/Pakistan (Gilgit Baltistan)_MICS5_Datasets/hh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/PAK_MICS5_Gilgit_Baltistan_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/PAK_MICS5_Gilgit_Baltistan_hh_dict.xlsx")
  ...
  data$survey <- "MICS"
  data$phase <- 5
  data$surveyid <- "PAK_MICS5_Gilgit_Baltistan"
