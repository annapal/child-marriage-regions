...
clean_MKD_MICS4 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Macedonia, The former Yugoslav Republic of_MICS4_Datasets/Macedonia, The former Yugoslav Republic of, MICS 2011 SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Macedonia, The former Yugoslav Republic of_MICS4_Datasets/Macedonia, The former Yugoslav Republic of, MICS 2011 SPSS Datasets/hh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/MKD_MICS4_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/MKD_MICS4_hh_dict.xlsx")
