...
clean_YEM_MICS3 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Yemen MICS 2006 SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Yemen MICS 2006 SPSS Datasets/hh.sav")
  bh <- read_sav("data/mics/raw_data/Yemen MICS 2006 SPSS Datasets/bh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/YEM_MICS3_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/YEM_MICS3_hh_dict.xlsx")
  write_xlsx(bh.dict, "data/mics/data_dictionaries/YEM_MICS3_bh_dict.xlsx")
  ...
  data$mar_status <- ifelse(mics$mstatus==1, "currently", 
                            ifelse(mics$mstatus==2, "formerly", NA))
