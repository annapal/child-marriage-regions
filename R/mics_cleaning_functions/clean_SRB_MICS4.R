...
clean_SRB_MICS4 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Serbia_MICS4_Datasets/Serbia MICS 2010 SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Serbia_MICS4_Datasets/Serbia MICS 2010 SPSS Datasets/hh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/SRB_MICS4_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/SRB_MICS4_hh_dict.xlsx")
  ...
  data$relig <- ifelse(data$relig=="doesn't want to comment", NA, data$relig)
  ...
  data$ethn <- ifelse(data$ethn=="doesn't want to comment", NA, data$ethn)
