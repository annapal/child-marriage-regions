...
clean_TCA_MICS6 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Turks and Caicos Islands MICS6 Datasets/Turks and Caicos Islands MICS6 SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Turks and Caicos Islands MICS6 Datasets/Turks and Caicos Islands MICS6 SPSS Datasets/hh.sav")
  bh <- read_sav("data/mics/raw_data/Turks and Caicos Islands MICS6 Datasets/Turks and Caicos Islands MICS6 SPSS Datasets/bh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/TCA_MICS6_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/TCA_MICS6_hh_dict.xlsx")
  write_xlsx(bh.dict, "data/mics/data_dictionaries/TCA_MICS6_bh_dict.xlsx")
  ...
  summary(data$psu)
  data$strata <- as.numeric(mics$dstratum)
  summary(data$strata)
  ...
  data$relig <- ifelse(data$relig=="missing/dk", NA, data$relig)
  data$relig <- ifelse(data$relig=="other religions", "other religion", data$relig)
  ...
  data$prev_reg <- ifelse(data$prev_reg=="outside of country (specifiy)", "international", data$prev_reg)
