...
clean_SRB_MICS3 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Serbia 2005-06 MICS_Datasets/Serbia MICS 2005 SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Serbia 2005-06 MICS_Datasets/Serbia MICS 2005 SPSS Datasets/hh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/SRB_MICS3_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/SRB_MICS3_hh_dict.xlsx")
