...
clean_TGO_MICS4 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Togo_MICS4_Datasets/Togo MICS 2010 SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Togo_MICS4_Datasets/Togo MICS 2010 SPSS Datasets/hh.sav")
  # No BH
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/TGO_MICS4_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/TGO_MICS4_hh_dict.xlsx")
