...
clean_TUN_MICS6 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Tunisia MICS6 Datasets/Tunisia MICS6 Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Tunisia MICS6 Datasets/Tunisia MICS6 Datasets/hh.sav")
  bh <- read_sav("data/mics/raw_data/Tunisia MICS6 Datasets/Tunisia MICS6 Datasets/bh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/TUN_MICS6_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/TUN_MICS6_hh_dict.xlsx")
  write_xlsx(bh.dict, "data/mics/data_dictionaries/TUN_MICS6_bh_dict.xlsx")
  ...
  data$al_lived <- ifelse(is.na(mics$WB15)|mics$WB15>=98, NA,
                          ifelse(mics$WB15==95, 1, 0))
  table(data$al_lived, useNA = "always")
  
  # Number of years lived in city/village
  data$yrs_lived <- ifelse(is.na(mics$WB15)|(mics$WB15 %in% c(99, 98, 95)), NA,
