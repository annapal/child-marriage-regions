...
clean_SLE_MICS3 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Sierra Leone 2005 MICS_Datasets/Sierra Leone MICS 2005 SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Sierra Leone 2005 MICS_Datasets/Sierra Leone MICS 2005 SPSS Datasets/hh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/SLE_MICS3_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/SLE_MICS3_hh_dict.xlsx")
