...
clean_STP_MICS6 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Sao Tome and Principe MICS6 Datasets/Sao Tome and Principe MICS6 SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Sao Tome and Principe MICS6 Datasets/Sao Tome and Principe MICS6 SPSS Datasets/hh.sav")
  bh <- read_sav("data/mics/raw_data/Sao Tome and Principe MICS6 Datasets/Sao Tome and Principe MICS6 SPSS Datasets/bh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/STP_MICS6_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/STP_MICS6_hh_dict.xlsx")
  write_xlsx(bh.dict, "data/mics/data_dictionaries/STP_MICS6_bh_dict.xlsx")
  ...
  # Religion
  data$relig <- tolower(as.character(as_factor(mics$religiaoChefe)))
  ...
  data$prev_reg <- ifelse(data$prev_reg=="sem resposta", NA, data$prev_reg)
  data$prev_reg <- ifelse(data$prev_reg=="fora do país (no estrangeiro)", "international", data$prev_reg)
