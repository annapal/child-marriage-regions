...
clean_SUR_MICS6 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Suriname MICS6 SPSS Datafiles/Suriname MICS6 SPSS Datafiles/wm.sav")
  hh <- read_sav("data/mics/raw_data/Suriname MICS6 SPSS Datafiles/Suriname MICS6 SPSS Datafiles/hh.sav")
  bh <- read_sav("data/mics/raw_data/Suriname MICS6 SPSS Datafiles/Suriname MICS6 SPSS Datafiles/bh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/SUR_MICS6_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/SUR_MICS6_hh_dict.xlsx")
  write_xlsx(bh.dict, "data/mics/data_dictionaries/SUR_MICS6_bh_dict.xlsx")
