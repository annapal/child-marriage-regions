...
clean_TUV_MICS6 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Tuvalu MICS6 Datasets/Tuvalu MICS6 SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Tuvalu MICS6 Datasets/Tuvalu MICS6 SPSS Datasets/hh.sav")
  bh <- read_sav("data/mics/raw_data/Tuvalu MICS6 Datasets/Tuvalu MICS6 SPSS Datasets/bh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/TUV_MICS6_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/TUV_MICS6_hh_dict.xlsx")
  write_xlsx(bh.dict, "data/mics/data_dictionaries/TUV_MICS6_bh_dict.xlsx")
  ...
  data$psu <- as.numeric(as.factor(mics$PSU_SE))
  summary(data$psu)
