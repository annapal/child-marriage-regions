...
clean_NGA_MICS5 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Nigeria MICS5 Datasets/Nigeria MICS 2016-17 SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Nigeria MICS5 Datasets/Nigeria MICS 2016-17 SPSS Datasets/hh.sav")
  bh <- read_sav("data/mics/raw_data/Nigeria MICS5 Datasets/Nigeria MICS 2016-17 SPSS Datasets/bh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/NGA_MICS5_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/NGA_MICS5_hh_dict.xlsx")
  write_xlsx(bh.dict, "data/mics/data_dictionaries/NGA_MICS5_bh_dict.xlsx")
  ...
  # Ever had sex
  data$sex_ev <- ifelse(mics$SB1%in%c(97,99), NA, 
                        ifelse(mics$SB1==0, 0, 
