...
clean_BFA_MICS3 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Burkina Faso MICS 2006 SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Burkina Faso MICS 2006 SPSS Datasets/hh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/BFA_MICS3_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/BFA_MICS3_hh_dict.xlsx")
