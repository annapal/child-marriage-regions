...
clean_PAK_MICS6_Balochistan <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Pakistan (Balochistan) MICS6 Datasets/Pakistan (Baluchistan) SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Pakistan (Balochistan) MICS6 Datasets/Pakistan (Baluchistan) SPSS Datasets/hh.sav")
  bh <- read_sav("data/mics/raw_data/Pakistan (Balochistan) MICS6 Datasets/Pakistan (Baluchistan) SPSS Datasets/bh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/PAK_MICS6_Balochistan_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/PAK_MICS6_Balochistan_hh_dict.xlsx")
  write_xlsx(bh.dict, "data/mics/data_dictionaries/PAK_MICS6_Balochistan_bh_dict.xlsx")
  ...
  data$survey <- "MICS"
  data$phase <- 6
  data$surveyid <- "PAK_MICS6_Balochistan"
