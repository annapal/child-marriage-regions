...
clean_MKD_MICS3 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Macedonia 2005-06 MICS_Datasets/Macedonia MICS 2005 SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Macedonia 2005-06 MICS_Datasets/Macedonia MICS 2005 SPSS Datasets/hh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/MKD_MICS3_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/MKD_MICS3_hh_dict.xlsx")
  ...
  data$relig <- ifelse(data$relig=="not declared", NA, data$relig)
  data$relig <- ifelse(data$relig=="christians", "christian", data$relig)
  data$relig <- ifelse(data$relig=="protestants", "protestant", data$relig)
