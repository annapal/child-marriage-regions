...
clean_XKO_MICS5 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Kosovo under UNSC res. 1244_MICS5_Datasets/Kosovo under UNSC res. 1244 MICS 2013-14 SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Kosovo under UNSC res. 1244_MICS5_Datasets/Kosovo under UNSC res. 1244 MICS 2013-14 SPSS Datasets/hh.sav")
  bh <- read_sav("data/mics/raw_data/Kosovo under UNSC res. 1244_MICS5_Datasets/Kosovo under UNSC res. 1244 MICS 2013-14 SPSS Datasets/bh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/XKO_MICS5_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/XKO_MICS5_hh_dict.xlsx")
  write_xlsx(bh.dict, "data/mics/data_dictionaries/XKO_MICS5_bh_dict.xlsx")
  ...
  data$relig <- ifelse(data$relig=="prefer not to answer", NA, data$relig)
