...
clean_GMB_MICS4 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/The Gambia_MICS4_Datasets/The Gambia 2010 SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/The Gambia_MICS4_Datasets/The Gambia 2010 SPSS Datasets/hh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/GMB_MICS4_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/GMB_MICS4_hh_dict.xlsx")
