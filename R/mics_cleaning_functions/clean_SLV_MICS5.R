...
clean_SLV_MICS5 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/El Salvador_MICS5_Datasets/El Salvador MICS 2014 SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/El Salvador_MICS5_Datasets/El Salvador MICS 2014 SPSS Datasets/hh.sav")
  bh <- read_sav("data/mics/raw_data/El Salvador_MICS5_Datasets/El Salvador MICS 2014 SPSS Datasets/bh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/SLV_MICS5_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/SLV_MICS5_hh_dict.xlsx")
  write_xlsx(bh.dict, "data/mics/data_dictionaries/SLV_MICS5_bh_dict.xlsx")
