...
clean_MNE_MICS6 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Montenegro MICS6 Datasets/Montenegro MICS6 SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Montenegro MICS6 Datasets/Montenegro MICS6 SPSS Datasets/hh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/MNE_MICS6_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/MNE_MICS6_hh_dict.xlsx")
