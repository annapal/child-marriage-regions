...
clean_GHA_MICS6 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Ghana MICS6 SPSS Datasets/Ghana MICS6 SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Ghana MICS6 SPSS Datasets/Ghana MICS6 SPSS Datasets/hh.sav")
  bh <- read_sav("data/mics/raw_data/Ghana MICS6 SPSS Datasets/Ghana MICS6 SPSS Datasets/bh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/GHA_MICS6_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/GHA_MICS6_hh_dict.xlsx")
  write_xlsx(bh.dict, "data/mics/data_dictionaries/GHA_MICS6_bh_dict.xlsx")
  ...
  data$prev_reg <- ifelse(data$prev_reg=="outside of ghana", "international", data$prev_reg)
