...
clean_CUB_MICS5 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Cuba_MICS5_Datasets/Cuba MICS 2014 SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Cuba_MICS5_Datasets/Cuba MICS 2014 SPSS Datasets/hh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/CUB_MICS5_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/CUB_MICS5_hh_dict.xlsx")
  ...
  data$prov <- tolower(as.character(as_factor(mics$prov)))
  data$dist <- NA
