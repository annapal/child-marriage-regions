...
clean_MEX_MICS5 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Mexico_MICS5_Datasets/Mexico MICS 2015 SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Mexico_MICS5_Datasets/Mexico MICS 2015 SPSS Datasets/hh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/MEX_MICS5_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/MEX_MICS5_hh_dict.xlsx")
