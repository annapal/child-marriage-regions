...
clean_BDI_MICS3 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Burundi MICS 2005 SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Burundi MICS 2005 SPSS Datasets/hh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/BDI_MICS3_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/BDI_MICS3_hh_dict.xlsx")
  ...
  data$dist <- tolower(as.character(as_factor(mics$HH1A)))
