...
clean_ZWE_MICS3 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Zimbabwe_Datasets/Zimbabwe MIMS 2009 SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Zimbabwe_Datasets/Zimbabwe MIMS 2009 SPSS Datasets/hh.sav")
  bh <- read_sav("data/mics/raw_data/Zimbabwe_Datasets/Zimbabwe MIMS 2009 SPSS Datasets/bh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/ZWE_MICS3_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/ZWE_MICS3_hh_dict.xlsx")
  write_xlsx(bh.dict, "data/mics/data_dictionaries/ZWE_MICS3_bh_dict.xlsx")
  ...
  mics <- merge(mics, bh, by=c("hh1", "hh2"), all.x=TRUE, suffixes = c("", ".bh"))
  ...
  data$relig <- ifelse(data$relig=="moslem", "muslim", data$relig)
  data$relig <- ifelse(data$relig=="other christians", "other christian religion", data$relig)
