...
clean_BGD_MICS5 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Bangladesh_MICS5_Datasets/Bangladesh MICS 2012-13 SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Bangladesh_MICS5_Datasets/Bangladesh MICS 2012-13 SPSS Datasets/hh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/BGD_MICS5_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/BGD_MICS5_hh_dict.xlsx")
