...
clean_SYR_MICS3 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Syria MICS 2006 SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Syria MICS 2006 SPSS Datasets/hh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/SYR_MICS3_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/SYR_MICS3_hh_dict.xlsx")
  ...
  # Marriage age
  data$mar_age <- as.numeric(mics$ma6a)
