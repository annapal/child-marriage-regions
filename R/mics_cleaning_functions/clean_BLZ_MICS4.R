...
clean_BLZ_MICS4 <- function(survey_var) {
  
  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Belize_MICS4_Datasets/Belize MICS 2011 SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Belize_MICS4_Datasets/Belize MICS 2011 SPSS Datasets/hh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/BLZ_MICS4_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/BLZ_MICS4_hh_dict.xlsx")
  ...
  data$ethn <- ifelse(data$ethn=="dk", NA, data$ethn)
  ...
  # Ever had sex
  data$sex_ev <- ifelse(mics$SB1==99|mics$SB1==97|mics$SB1==98, NA, 
                        ifelse(mics$SB1==0, 0, 
  ...
  data$sex_age <- ifelse((data$sex_age==99)|(data$sex_age==0)|(data$sex_age==97)|(data$sex_age==98), NA, 
