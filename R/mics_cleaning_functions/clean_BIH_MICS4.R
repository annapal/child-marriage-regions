...
clean_BIH_MICS4 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Bosnia and Herzegovina_MICS4_Datasets/Bosnia and Herzegovina MICS 2011-12 SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Bosnia and Herzegovina_MICS4_Datasets/Bosnia and Herzegovina MICS 2011-12 SPSS Datasets/hh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/BIH_MICS4_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/BIH_MICS4_hh_dict.xlsx")
  ...
  data$prov <- NA
  data$dist <- tolower(as.character(as_factor(mics$HH7A)))
