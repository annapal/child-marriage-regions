...
clean_MNG_MICS6 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Mongolia MICS 2018 SPSS Datasets/Mongolia MICS 2018 SPSS Datasets/wm.sav", encoding="latin1")
  hh <- read_sav("data/mics/raw_data/Mongolia MICS 2018 SPSS Datasets/Mongolia MICS 2018 SPSS Datasets/hh.sav")
  bh <- read_sav("data/mics/raw_data/Mongolia MICS 2018 SPSS Datasets/Mongolia MICS 2018 SPSS Datasets/bh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/MNG_MICS6_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/MNG_MICS6_hh_dict.xlsx")
  write_xlsx(bh.dict, "data/mics/data_dictionaries/MNG_MICS6_bh_dict.xlsx")
  ...
  data$prov <- tolower(as.character(as_factor(mics$province)))
  data$dist <- NA
