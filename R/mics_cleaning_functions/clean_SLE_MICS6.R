...
clean_SLE_MICS6 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Sierra Leone MICS6 Datasets/Sierra Leone MICS6 Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Sierra Leone MICS6 Datasets/Sierra Leone MICS6 Datasets/hh.sav")
  bh <- read_sav("data/mics/raw_data/Sierra Leone MICS6 Datasets/Sierra Leone MICS6 Datasets/bh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/SLE_MICS6_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/SLE_MICS6_hh_dict.xlsx")
  write_xlsx(bh.dict, "data/mics/data_dictionaries/SLE_MICS6_bh_dict.xlsx")
  ...
  data$prev_reg <- ifelse(data$prev_reg=="outside of sierra leone", "international", data$prev_reg)
