...
clean_VNM_MICS6 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Viet Nam MICS6 Datasets/Viet Nam MICS6 SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Viet Nam MICS6 Datasets/Viet Nam MICS6 SPSS Datasets/hh.sav")
  bh <- read_sav("data/mics/raw_data/Viet Nam MICS6 Datasets/Viet Nam MICS6 SPSS Datasets/bh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/VNM_MICS6_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/VNM_MICS6_hh_dict.xlsx")
  write_xlsx(bh.dict, "data/mics/data_dictionaries/VNM_MICS6_bh_dict.xlsx")
  ...
  summary(data$psu) # Should match cluster numbers
  data$strata <- as.numeric(mics$stratum)
  summary(data$strata) # Max should be 25-100 ish?
  ...
  data$prev_reg <- ifelse(data$prev_reg=="outside of vietnam", "international", data$prev_reg)
