...
clean_PAK_MICS5_Sindh <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Pakistan (Sindh)_MICS5_Datasets/Pakistan (Sindh) MICS 2014 SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Pakistan (Sindh)_MICS5_Datasets/Pakistan (Sindh) MICS 2014 SPSS Datasets/hh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/PAK_MICS5_Sindh_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/PAK_MICS5_Sindh_hh_dict.xlsx")
  ...
  data$relig <- ifelse(data$relig=="christianity", "christian", data$relig)
