...
clean_SRB_MICS5 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Serbia_MICS5_Datasets/Serbia MICS 2014 SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Serbia_MICS5_Datasets/Serbia MICS 2014 SPSS Datasets/hh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/SRB_MICS5_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/SRB_MICS5_hh_dict.xlsx")
  ...
  data$ethn <- ifelse(data$ethn=="missing"|data$ethn=="refuse to answer", NA, data$ethn)
