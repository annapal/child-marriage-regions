...
clean_CMR_MICS5 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Cameroon_MICS5_Datasets/Cameroon MICS 2014 SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Cameroon_MICS5_Datasets/Cameroon MICS 2014 SPSS Datasets/hh.sav")
  bh <- read_sav("data/mics/raw_data/Cameroon_MICS5_Datasets/Cameroon MICS 2014 SPSS Datasets/bh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/CMR_MICS5_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/CMR_MICS5_hh_dict.xlsx")
  write_xlsx(bh.dict, "data/mics/data_dictionaries/CMR_MICS5_bh_dict.xlsx")
  ...
  data$relig <- ifelse(data$relig=="autre chrétien", "other christian religion", data$relig)
  data$relig <- ifelse(data$relig=="autre religion (non chrétien)", "other religion", data$relig)
  ...
  # Ever had sex
  data$sex_ev <- ifelse(mics$SB1==99|mics$SB1==98|mics$SB1==97, NA, 
                        ifelse(mics$SB1==0, 0, 
  ...
  data$sex_age <- ifelse((data$sex_age==99)|data$sex_age==98|data$sex_age==97|(data$sex_age==0), NA, 
