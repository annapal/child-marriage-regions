...
clean_THA_MICS6_2 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Thailand MICS6 2022 Datasets/Thailand MICS6 2022 SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Thailand MICS6 2022 Datasets/Thailand MICS6 2022 SPSS Datasets/hh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/THA_MICS6_2_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/THA_MICS6_2_hh_dict.xlsx")
