...
clean_PAK_MICS6_Punjab <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Pakistan Punjab MICS6 Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Pakistan Punjab MICS6 Datasets/hh.sav")
  bh <- read_sav("data/mics/raw_data/Pakistan Punjab MICS6 Datasets/bh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/PAK_MICS6_Punjab_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/PAK_MICS6_Punjab_hh_dict.xlsx")
  write_xlsx(bh.dict, "data/mics/data_dictionaries/PAK_MICS6_Punjab_bh_dict.xlsx")
  ...
  data$survey <- "MICS"
  data$phase <- 6
  data$surveyid <- "PAK_MICS6_Punjab"
  ...
  data$al_lived <- ifelse(is.na(mics$WB15)|mics$WB15>=97, NA,
