...
clean_BRB_MICS4 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Barbados_MICS4_Datasets/Barbados MICS 2012 SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Barbados_MICS4_Datasets/Barbados MICS 2012 SPSS Datasets/hh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/BRB_MICS4_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/BRB_MICS4_hh_dict.xlsx")
