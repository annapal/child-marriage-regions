...
clean_PAN_MICS5 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Panama_MICS5_Datasets/Panama MICS 2013 SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Panama_MICS5_Datasets/Panama MICS 2013 SPSS Datasets/hh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/PAN_MICS5_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/PAN_MICS5_hh_dict.xlsx")
