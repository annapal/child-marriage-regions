...
clean_GNB_MICS5 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Guinea Bissau_MICS5_Datasets/Guinea Bissau MICS 2014 SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Guinea Bissau_MICS5_Datasets/Guinea Bissau MICS 2014 SPSS Datasets/hh.sav")
  bh <- read_sav("data/mics/raw_data/Guinea Bissau_MICS5_Datasets/Guinea Bissau MICS 2014 SPSS Datasets/bh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/GNB_MICS5_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/GNB_MICS5_hh_dict.xlsx")
  write_xlsx(bh.dict, "data/mics/data_dictionaries/GNB_MICS5_bh_dict.xlsx")
  ...
  data$relig <- ifelse(data$relig=="anemista", "anemist", data$relig)
  data$relig <- ifelse(data$relig=="católico", "catholic", data$relig)
  data$relig <- ifelse(data$relig=="evangélicos", "evangelical", data$relig)
  data$relig <- ifelse(data$relig=="muçulmana", "muslim", data$relig)
  data$relig <- ifelse(data$relig=="outra religião", "other religion", data$relig)
  data$relig <- ifelse(data$relig=="sem religião", "no religion", data$relig)
