...
clean_THA_MICS6 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Thailand MICS6 and Thailand Selected 17 Provinces MICS6 Datasets/Thailand MICS6 Datasets/Thailand MICS6 SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Thailand MICS6 and Thailand Selected 17 Provinces MICS6 Datasets/Thailand MICS6 Datasets/Thailand MICS6 SPSS Datasets/hh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/THA_MICS6_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/THA_MICS6_hh_dict.xlsx")
  ...
  data$prev_reg <- ifelse(data$prev_reg=="overseas", "international", data$prev_reg)
  ...
  data$birth1_age <- as.numeric(mics$CM16D)
