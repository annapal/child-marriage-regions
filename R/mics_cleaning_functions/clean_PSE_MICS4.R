...
clean_PSE_MICS4 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/State of Palestine_MICS4_Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/State of Palestine_MICS4_Datasets/hh.sav")
  bh <- read_sav("data/mics/raw_data/State of Palestine_MICS4_Datasets/bh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/PSE_MICS4_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/PSE_MICS4_hh_dict.xlsx")
  write_xlsx(bh.dict, "data/mics/data_dictionaries/PSE_MICS4_bh_dict.xlsx")
  ...
  table(mics$PWM7)
  val_labels(mics$PWM7)
  mics <- subset(mics, PWM7==1)
  ...
  # Age at interview
  data$age <- as.numeric(mics$PPWB2)
  summary(data$age)
