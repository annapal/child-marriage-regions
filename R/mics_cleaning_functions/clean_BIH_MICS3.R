...
clean_BIH_MICS3 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Bosnia and Herzegovina 2006 MICS_Datasets/Bosnia MICS 2006 SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Bosnia and Herzegovina 2006 MICS_Datasets/Bosnia MICS 2006 SPSS Datasets/hh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/BIH_MICS3_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/BIH_MICS3_hh_dict.xlsx")
  ...
  data$prov <- NA
  data$dist <- tolower(as.character(as_factor(mics$hh7_det)))
