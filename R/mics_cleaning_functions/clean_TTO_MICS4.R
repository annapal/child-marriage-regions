...
clean_TTO_MICS4 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Trinidad and Tobago_MICS4_Datasets/Trinidad and Tobago MICS 2011 SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Trinidad and Tobago_MICS4_Datasets/Trinidad and Tobago MICS 2011 SPSS Datasets/hh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/TTO_MICS4_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/TTO_MICS4_hh_dict.xlsx")
  ...
  data$ethn <- ifelse(data$ethn=="other/no stated", NA, data$ethn)
