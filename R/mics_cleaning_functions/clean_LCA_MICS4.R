...
clean_LCA_MICS4 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/St.Lucia_MICS4_Datasets/MICS St.Lucia 2012 SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/St.Lucia_MICS4_Datasets/MICS St.Lucia 2012 SPSS Datasets/hh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/LCA_MICS4_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/LCA_MICS4_hh_dict.xlsx")
  ...
  data$relig <- ifelse(data$relig=="other christian (specify)", "other christian religion", data$relig)
  data$relig <- ifelse(data$relig=="other religion (specify)", "other religion", data$relig)
