...
clean_MDA_MICS4 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Moldova_MICS4_Datasets/Moldova MICS 2012 SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Moldova_MICS4_Datasets/Moldova MICS 2012 SPSS Datasets/hh.sav")
  bh <- read_sav("data/mics/raw_data/Moldova_MICS4_Datasets/Moldova MICS 2012 SPSS Datasets/ch.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/MDA_MICS4_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/MDA_MICS4_hh_dict.xlsx")
  write_xlsx(bh.dict, "data/mics/data_dictionaries/MDA_MICS4_bh_dict.xlsx")
