...
clean_PSE_MICS6 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/State of Palestine MICS6 Datasets/State of Palestine MICS6 SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/State of Palestine MICS6 Datasets/State of Palestine MICS6 SPSS Datasets/hh.sav")
  bh <- read_sav("data/mics/raw_data/State of Palestine MICS6 Datasets/State of Palestine MICS6 SPSS Datasets/bh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/PSE_MICS6_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/PSE_MICS6_hh_dict.xlsx")
  write_xlsx(bh.dict, "data/mics/data_dictionaries/PSE_MICS6_bh_dict.xlsx")
  ...
  data$res <- ifelse(mics$HH6==1, "urban", 
                     ifelse(mics$HH6==2, "rural", 
                            ifelse(mics$HH6==3, "camp", NA)))
