...
clean_HND_MICS6 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Honduras MICS6 Datasets/Honudras MICS6 SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Honduras MICS6 Datasets/Honudras MICS6 SPSS Datasets/hh.sav")
  bh <- read_sav("data/mics/raw_data/Honduras MICS6 Datasets/Honudras MICS6 SPSS Datasets/bh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/HND_MICS6_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/HND_MICS6_hh_dict.xlsx")
  write_xlsx(bh.dict, "data/mics/data_dictionaries/HND_MICS6_bh_dict.xlsx")
  ...
  # Religion
  data$relig <- tolower(as.character(as_factor(mics$HC1)))
  data$relig <- ifelse(data$relig=="no responde", NA, data$relig)
