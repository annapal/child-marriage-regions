...
clean_TUN_MICS4 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Tunisia_MICS4_Datasets/Tunisia MICS 2011-12 SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Tunisia_MICS4_Datasets/Tunisia MICS 2011-12 SPSS Datasets/hh.sav")
  bh <- read_sav("data/mics/raw_data/Tunisia_MICS4_Datasets/Tunisia MICS 2011-12 SPSS Datasets/bh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/TUN_MICS4_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/TUN_MICS4_hh_dict.xlsx")
  write_xlsx(bh.dict, "data/mics/data_dictionaries/TUN_MICS4_bh_dict.xlsx")
