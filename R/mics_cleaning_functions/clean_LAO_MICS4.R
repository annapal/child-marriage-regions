...
clean_LAO_MICS4 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Lao People's Democratic Republic_LSIS_Datasets/Lao People's Democratic Republic LSIS 2011-12 SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Lao People's Democratic Republic_LSIS_Datasets/Lao People's Democratic Republic LSIS 2011-12 SPSS Datasets/hh.sav")
  bh <- read_sav("data/mics/raw_data/Lao People's Democratic Republic_LSIS_Datasets/Lao People's Democratic Republic LSIS 2011-12 SPSS Datasets/bh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/LAO_MICS4_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/LAO_MICS4_hh_dict.xlsx")
  write_xlsx(bh.dict, "data/mics/data_dictionaries/LAO_MICS4_bh_dict.xlsx")
  ...
  data$res <- ifelse(mics$HH6==1, "urban", "rural")
