...
clean_THA_MICS4 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Thailand_MICS4_Datasets/Thailand MICS 2012-13 SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Thailand_MICS4_Datasets/Thailand MICS 2012-13 SPSS Datasets/hh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/THA_MICS4_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/THA_MICS4_hh_dict.xlsx")
