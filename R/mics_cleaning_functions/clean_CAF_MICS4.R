...
clean_CAF_MICS4 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Central African Republic_MICS4_Datasets/Central African Republic MICS 2010 SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Central African Republic_MICS4_Datasets/Central African Republic MICS 2010 SPSS Datasets/hh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/CAF_MICS4_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/CAD_MICS4_hh_dict.xlsx")
  ...
  data$sex_age <- ifelse((data$sex_age==99)|(data$sex_age==97)|(data$sex_age==0), NA, 
