...
clean_MLI_MICS4 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Mali_MICS4_Datasets/Mali MICS 2009-10 SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Mali_MICS4_Datasets/Mali MICS 2009-10 SPSS Datasets/hh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/MLI_MICS4_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/MLI_MICS4_hh_dict.xlsx")
  ...
  data$relig <- ifelse(data$relig=="autre réligion", "other religion", data$relig)
  data$relig <- ifelse(data$relig=="musulmane", "muslim", data$relig)
  data$relig <- ifelse(data$relig=="pas de réligion", "no religion", data$relig)
  data$relig <- ifelse(data$relig=="chrétienne", "christian", data$relig)
