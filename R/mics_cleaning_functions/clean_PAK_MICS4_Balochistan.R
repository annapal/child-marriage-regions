...
clean_PAK_MICS4_Balochistan <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Pakistan (Balochistan)_MICS4_Datasets/Pakistan (Balochistan) MICS 2010 SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Pakistan (Balochistan)_MICS4_Datasets/Pakistan (Balochistan) MICS 2010 SPSS Datasets/hh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/PAK_MICS4_Balochistan_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/PAK_MICS4_Balochistan_hh_dict.xlsx")
  ...
  data$survey <- "MICS"
  data$phase <- 4
  data$surveyid <- "PAK_MICS4_Balochistan"
