...
clean_SWZ_MICS4 <- function(survey_var) {

  # Import MICS data files
  wm <- read_sav("data/mics/raw_data/Swaziland_MICS4_Datasets/Swaziland MICS 2010 SPSS Datasets/wm.sav")
  hh <- read_sav("data/mics/raw_data/Swaziland_MICS4_Datasets/Swaziland MICS 2010 SPSS Datasets/hh.sav")
  bh <- read_sav("data/mics/raw_data/Swaziland_MICS4_Datasets/Swaziland MICS 2010 SPSS Datasets/bh.sav")
  ...
  write_xlsx(wm.dict, "data/mics/data_dictionaries/SWZ_MICS4_wm_dict.xlsx")
  write_xlsx(hh.dict, "data/mics/data_dictionaries/SWZ_MICS4_hh_dict.xlsx")
  write_xlsx(bh.dict, "data/mics/data_dictionaries/SWZ_MICS4_bh_dict.xlsx")
